...
class SplitClipCommand(CommandInterface):
    ...
    def execute(self):
        ...
        self.time_line.add(self.new_fr_1.id, self.new_fr_1)
        self.time_line.add(self.new_fr_2.id, self.new_fr_2)

    def undo(self):
        self.time_line.remove(self.new_fr_1)
        self.time_line.remove(self.new_fr_2)
        self.time_line.add(self.fragment.id, self.fragment)